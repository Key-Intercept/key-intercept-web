...
export default function SelectedRule({
	...
	function setEditorModeButtonClicked(mode: RuleType) {
		setEditorMode(mode);
		setLocalRule({
			id: -1n,
			config_id: -1n,
		...
		<Card title={isNewRule ? "Add New Rule" : "Selected Rule"}>
			<div style={buttonContainerStyle}>
				<RuleEditorModeButton
					...
					setMode={() => setEditorModeButtonClicked(RuleType.Custom)}
				/>
				<RuleEditorModeButton
					key={RuleType.Swap}
					mode={RuleType.Swap}
					icon="🔁"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Swap)}
				/>
				<RuleEditorModeButton
					...
					icon="🔤"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Letters)}
				/>
				<RuleEditorModeButton
					...
					icon="🔣"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Charset)}
				/>
				<RuleEditorModeButton
					...
					icon="👀"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Lookaround)}
				/>
				<RuleEditorModeButton
					key={RuleType.Prefix}
					...
					icon="<<"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Prefix)}
				/>
				<RuleEditorModeButton
					key={RuleType.Suffix}
					...
					icon=">>"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Suffix)}
				/>
				<RuleEditorModeButton
					...
					icon="<"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.WordPrefix)}
				/>
				<RuleEditorModeButton
					...
					icon=">"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.WordSuffix)}
				/>
				<RuleEditorModeButton
					key={RuleType.Bold}
					mode={RuleType.Bold}
					icon="𝐁"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Bold)}
				/>
				<RuleEditorModeButton
					key={RuleType.Italic}
					...
					icon="𝐼"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Italic)}
				/>
				<RuleEditorModeButton
					...
					icon="𝑩"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.BoltItalic)}
				/>
				<RuleEditorModeButton
					...
					icon="𝑈"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Underline)}
				/>
				<RuleEditorModeButton
					...
					icon="S"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Strikethrough)}
				/>
				<RuleEditorModeButton
					key={RuleType.Code}
					mode={RuleType.Code}
					icon="</>"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Code)}
				/>
				<RuleEditorModeButton
					...
					icon="S"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Spoiler)}
				/>
				<RuleEditorModeButton
					key={RuleType.Quote}
					mode={RuleType.Quote}
					icon="❝"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Quote)}
				/>
				<RuleEditorModeButton
					key={RuleType.Sub}
					mode={RuleType.Sub}
					icon="-#"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Sub)}
				/>
				<RuleEditorModeButton
					key={RuleType.Super}
					mode={RuleType.Super}
					icon="#"
					currentMode={editorMode}
					setMode={() => setEditorModeButtonClicked(RuleType.Super)}
				/>
			</div>
			<Separator color="#333" />
